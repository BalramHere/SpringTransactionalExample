...
import com.springtransaction.repo.AppointmentRepo;
import com.springtransaction.repo.PatientRepo;
...
public class BookAppointmentService {
    ...
    public String bookAppointment(AppointmentFormDto appointmentFormDto) {
      ...
      System.out.println(10 / 0);
        Appointment appointment = Appointment.builder().date(new Date(System.currentTimeMillis()))
                .doctorNo(101l)
                .patientNo(patientNo)
                .build();
